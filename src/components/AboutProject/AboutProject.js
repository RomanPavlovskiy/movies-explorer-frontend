    ...
    <section className='about-project'>
      ...
      <ul className='about-project__deadlines'>
        <li className='about-project__deadline'>
          <p className='about-project__deadline-subtitle about-project__deadline-subtitle_backend'>1 неделя</p>
          <p className='about-project__deadline-text'>Back-end</p>
        </li>
        <li className='about-project__deadline'>
          <p className='about-project__deadline-subtitle about-project__deadline-subtitle_frontend'>4 недели</p>
